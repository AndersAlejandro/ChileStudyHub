...
export const createCurso = async (data) => {
  const { nombre, descripcion, fecha_inicio, fecha_termino, portada, id_area } =
    data;
  const text =
    "INSERT INTO cursos (nombre, descripcion, fecha_inicio, fecha_termino, portada, id_area) VALUES ($1, $2, $3, $4, $5, $6)";
  const values = [
    nombre,
    descripcion,
    fecha_inicio,
...
export const updateCurso = async (data, id) => {
  const { nombre, descripcion, fecha_inicio, fecha_termino, portada, id_area } =
    data;
  const text =
    "UPDATE cursos SET nombre = $1, descripcion = $2, fecha_inicio = $3, fecha_termino = $4, portada = $5, id_area = $6 WHERE id = $7";
  const values = [
    nombre,
    descripcion,
    fecha_inicio,
